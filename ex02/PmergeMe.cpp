...
void	PmergeMe::checkVectorSort(void)
{
	...
	std::cout << "Success: Vector is sorted" << std::endl;
}

int PmergeMe::getVectorSize(void) const
{
...
void	PmergeMe::listInsertionSort(int begin, int end)
{
...
void	PmergeMe::listMergeSort(int begin, int end)
{
...
void	PmergeMe::checkListSort(void)
{
	...
	std::cout << "Success: list is sorted" << std::endl;
}
